<div class="card border-0 mb-4 mt-2">
    <div class="card-header font-weight-bold text-primary">List SAW
                        ...
                        <form action="{{route('saw.store')}}" method="post">
                            ...
                            <td>
                                ...
                                <select name="weight[]" class="form-controll" required>
                                    ...
                                    <option value="{{$sub_criteria->weight}}" @foreach ($media->saw as $saw)
                                        {{($criteria->id == $saw->criteria_id && 
                                                $sub_criteria->weight == $saw->weight)?'selected':''}}
                                        @endforeach
