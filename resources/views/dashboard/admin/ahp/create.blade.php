<div class="card border-0 mb-4 mt-2">
    <div class="card-header font-weight-bold text-primary">List ahp
                        ...
                        <form action="{{route('ahp.store')}}" method="post">
                            ...
                            <td>
                                ...
                                <select name="weight[]" class="form-controll" required>
                                    ...
                                    <option value="{{$sub_criteria->weight}}" @foreach ($media->ahp as $ahp)
                                        {{($criteria->id == $ahp->criteria_id && 
                                                $sub_criteria->weight == $ahp->weight)?'selected':''}}
                                        @endforeach
